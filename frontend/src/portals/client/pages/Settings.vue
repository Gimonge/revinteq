  ...
  <div style="display:flex;flex-direction:column;gap:18px">
    ...
    <div class="rv-g2">
      ...
      <div class="rv-card card-reveal">
        ...
        <div class="rv-cb">
          <div v-if="saved" class="rv-al rv-al-g" style="margin-bottom:14px">✅ Settings saved!</div>
      ...
      <div class="rv-card card-reveal" style="animation-delay:.08s">
        ...
        <div class="rv-cb">
          ...
          <button class="rv-btn rv-btn-p rv-btn-sm" @click="saveCap" :disabled="savingCap">💾 Save Cap</button>
        </div>
      </div>
    </div>
    <!-- Connected accounts -->
      ...
      <div class="rv-cb" style="padding:0">
        <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid var(--border)">
          <div style="display:flex;align-items:center;gap:12px">
            <div style="width:38px;height:38px;border-radius:var(--r-md);background:var(--blue-light);display:flex;align-items:center;justify-content:center;font-size:20px">📘</div>
          ...
          <span class="rv-badge" :class="fbConnected?'rv-bg':'rv-bgy'">{{ fbConnected?'✓ Connected':'Not Connected' }}</span>
        </div>
        <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid var(--border)">
          <div style="display:flex;align-items:center;gap:12px">
            <div style="width:38px;height:38px;border-radius:var(--r-md);background:linear-gradient(135deg,var(--ig1),var(--ig3));display:flex;align-items:center;justify-content:center;font-size:20px">📸</div>
          ...
          <span class="rv-badge" :class="igConnected?'rv-big':'rv-bgy'">{{ igConnected?'✓ Connected':'Not Connected' }}</span>
        </div>
        <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 20px">
          <div style="display:flex;align-items:center;gap:12px">
            <div style="width:38px;height:38px;border-radius:var(--r-md);background:var(--green-light);display:flex;align-items:center;justify-content:center;font-size:20px">💬</div>
          ...
          <span class="rv-badge" :class="form.whatsapp_number?'rv-bg':'rv-bgy'">{{ form.whatsapp_number?'✓ Active':'Not configured' }}</span>
        </div>
      </div>
    </div>
  </div>
