<template>
  <nav class="rv-sidebar">
    ...
    <div class="rv-nav-item" :class="{active:page==='overview'}" @click="nav('overview')">
      <span class="rv-nav-icon"><i class="ti ti-home" aria-hidden="true"></i></span> Dashboard
    </div>
    <div class="rv-nav-item" :class="{active:page==='clients'}" @click="nav('clients')">
      <span class="rv-nav-icon"><i class="ti ti-building" aria-hidden="true"></i></span> All Clients
    ...
    <div class="rv-nav-item" :class="{active:page==='add-client'}" @click="nav('add-client')">
      <span class="rv-nav-icon"><i class="ti ti-plus" aria-hidden="true"></i></span> Add New Client
    </div>

    <div class="rv-sb-section">Configuration</div>
    <div class="rv-nav-item" :class="{active:page==='mpesa'}" @click="nav('mpesa')">
      <span class="rv-nav-icon"><i class="ti ti-heart" aria-hidden="true"></i></span> M-Pesa Setup
    </div>
    <div class="rv-nav-item" :class="{active:page==='sms'}" @click="nav('sms')">
      <span class="rv-nav-icon"><i class="ti ti-device-mobile" aria-hidden="true"></i></span> SMS Setup
    </div>
    <div class="rv-nav-item" :class="{active:page==='api-keys'}" @click="nav('api-keys')">
      <span class="rv-nav-icon"><i class="ti ti-key" aria-hidden="true"></i></span> API Keys
    </div>

    <div class="rv-sb-section">Intelligence</div>
    <div class="rv-nav-item" :class="{active:page==='analytics'}" @click="nav('analytics')">
      <span class="rv-nav-icon"><i class="ti ti-chart-bar" aria-hidden="true"></i></span> Cross-Client Analytics
    </div>
    <div class="rv-nav-item" :class="{active:page==='recommendations'}" @click="nav('recommendations')">
      <span class="rv-nav-icon"><i class="ti ti-bulb" aria-hidden="true"></i></span> All Recommendations
